...
# Saída em csv
matriculas_por_curso.to_csv('../data/associacao_alunos_cursos.csv', sep=";")

# Saída em json
matriculas_por_curso.to_json('../data/associacao_alunos_cursos.json')

# Saída em htlml
matriculas_por_curso.to_html('../data/associacao_alunos_cursos.html')